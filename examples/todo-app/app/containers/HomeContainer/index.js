...
import { getApi, createApiClientWithTransform } from '../../jsonapi-redux-data'
import {
  selectHomeContainer,
  selectReposData,
  selectReposError,
...
export function HomeContainer ({
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      // a much more complicated backend
      const api = createApiClientWithTransform('http://api.dev.heroleague.io:5000/', store)
      getApi({
        pathname: 'matchteams',
        include:
          'team,match_players,match.home_team.match_players,match.away_team,match_events,league',
          levelOfNesting: 4,
        transformList: {
          'awayTeam': 'matchteam',
          'homeTeam': 'matchteam',
...
export default compose(injectIntl, withConnect, memo, withRouter)(HomeContainer)
